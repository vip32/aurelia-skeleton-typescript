...
This skeleton is part of the [Aurelia](http://www.aurelia.io/) platform. It sets up a standard navigation-style app using gulp to build your Typescript code with the tsc compiler. Karma/Protractor/Jasmine testing is also configured.
...
5. Install the typescript definitions:
